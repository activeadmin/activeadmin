  ...
  class TestApplication
    ...
    def soft_generate
      ...
      Bundler.with_original_env do
        Kernel.system("pnpm install") # so tailwindcss/plugin is available for test app
        Kernel.system("rake dependencies:vendor") # ensure flowbite is updated for test app
        Dir.chdir(app_dir) do
          Kernel.system("pnpm add @activeadmin/activeadmin")
          Kernel.system('pnpm pkg set scripts.build:css="npx @tailwindcss/cli -i ./app/assets/stylesheets/active_admin.css -o ./app/assets/builds/active_admin.css --minify"')
          Kernel.system("pnpm install")
          Kernel.system("pnpm build:css")
        end
      end
    end
