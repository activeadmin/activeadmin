...
If you are using Rails >= 3.1, you must also include sass-rails (if already present in assets group, move it out):

  # Gemfile in Rails >= 3.1
  gem 'activeadmin'
  gem 'sass-rails'

and add active_admin assets into precompiling by adding the following line into your config/environments/production.rb:

  config.assets.precompile += %w[active_admin.css active_admin.js]

There is also some issue with precompiling activeadmin images in Rails 3.1.0, it is fixed in Rails 3.1.1.rc1.
