...
module ActiveAdmin
  ...
  autoload :PaginationAdapter, "active_admin/pagination_adapter"
  autoload :KaminariAdapter, "active_admin/kaminari_adapter"
  autoload :PagyAdapter, "active_admin/pagy_adapter"
