    ...
    class PaginatedCollection < ActiveAdmin::Component
      ...
      def build_pagination_with_formats(options)
        div class: "paginated-collection-pagination" do
          div helpers.active_admin_page_entries_info(@collection, options.merge(pagination_total: @display_total)).html_safe, class: "pagination-information"
          build_pagination
        end
      ...
      def build_pagination
        ...
        text_node helpers.active_admin_paginate @collection, **options
      end
    end
  end
end
