  ...
  module Views
    ...
    class IndexAsTable < ActiveAdmin::Component
      ...
      class IndexTableFor < ::ActiveAdmin::Views::TableFor
        ...
        # actions defaults: false, dropdown: true do |admin_user|
        #   item 'Grant Admin', grant_admin_admin_user_path(admin_user)
        # end
        #
        # ```
        def actions(options = {}, &block)
          options = {
            ...
            :defaults => true,
            :dropdown => false,
            :dropdown_menu_button_label => I18n.t("active_admin.dropdown_actions.button_label", default: "Actions")
          }.merge(options)
          column options[:name] do |resource|
            if options[:dropdown]
              dropdown_menu options[:dropdown_menu_button_label] do
