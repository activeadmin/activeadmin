      ...
      def add_default_action_items
        ...
        add_action_item :except => [:new, :show] do
          if controller.action_methods.include?('new')
            link_to(I18n.t('active_admin.new_model', :model => I18n.t(active_admin_config.resource_label)), new_resource_path)
          end
        end
        ...
        add_action_item :only => :show do
          if controller.action_methods.include?('edit')
            link_to(I18n.t('active_admin.edit_model', :model => I18n.t(active_admin_config.resource_label)), edit_resource_path(resource))
          end
        end
        ...
        add_action_item :only => :show do
          if controller.action_methods.include?("destroy")
            link_to(I18n.t('active_admin.delete_model', :model => I18n.t(active_admin_config.resource_label)),
